...
- 实现 BFS、Dijkstra、A*、single-source distance map、reachable、topological sort、topological layers 和 acyclic checks。
- 实现弱连通分量、强连通分量和图转置。
...
- 编写 13 个黑盒测试，覆盖最短路、单源距离、BFS、拓扑排序、拓扑分层、图结构分析、强/弱连通分量、grid A*、terrain costs、corner cutting、grid-to-graph 和启发函数。
