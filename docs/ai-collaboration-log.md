...
- 扩展 DFS、bidirectional Dijkstra、path scoring、edge-list export/rebuild、induced subgraph、path existence、weak/strong connected components、graph transpose、single-source distance map、all-pairs distance map、eccentricity、diameter、topological layers、terrain costs、grid Dijkstra、grid export/rebuild、rectangular grid updates、no-corner-cutting pathfinding 和 grid-to-graph，让项目更接近可复用基础库。
