...
- 提供 `Grid`、`Point` 和 `CellCost`，支持 blocked cells、terrain costs、blocked/terrain export、grid rebuild、rectangular bulk updates、line-of-sight、path smoothing、grid path validation、path cost recomputation、4 邻接、8 邻接、禁止穿角的 8 邻接 tile-grid 寻路和 heuristic-free grid Dijkstra。
